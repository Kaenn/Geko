...
function addFieldToData(data){
	...
	data.forEach(function(d){
		if("ipAdEntAddr" in d && "ipAdEntNetMask" in d){
			d['ip_with_mask']=d["ipAdEntAddr"]+"_"+d['ipAdEntNetMask'];
		}
...
function getDataProxy1(){
	...
	var data=[  
	    {        "sysName":"fb-fw1-finatech", "ipAdEntAddr":"10.0.0.1",        "ipAdEntNetMask":"255.255.255.255",        "ifDescr":"lo0.16385",        "ifPhysAddress":"",        "ifType":"softwareLoopback(24)"      }
	    ,
	    {        "sysName":"fb-fw1-finatech", "ipAdEntAddr":"150.150.150.1",        "ipAdEntNetMask":"255.255.255.0",        "ifDescr":"lo0.16385",        "ifPhysAddress":"",        "ifType":"softwareLoopback(24)"      }
	    ,
	    {        "sysName":"host2" , "ipAdEntAddr":"10.6.3.214",        "ipAdEntNetMask":"255.255.252.0",        "ifDescr":"lo0.16385",        "ifPhysAddress":"",        "ifType":"softwareLoopback(24)"      }
	    ,
		{       "sysName":"host3",  "ipAdEntAddr":"10.2.4.87",        "ipAdEntNetMask":"255.255.225.0",        "ifDescr":"lo0.16385",        "ifPhysAddress":"",        "ifType":"softwareLoopback(24)"      }
	    ,
		{        "sysName":"host3", "ipAdEntAddr":"10.2.4.88",        "ipAdEntNetMask":"255.255.225.0",        "ifDescr":"lo0.16385",        "ifPhysAddress":"",        "ifType":"softwareLoopback(24)"      }
	];
