 ...
 * @author : Kaenn
 */
var consistencyManager = require('../API/controler/ConsistencyManager');


function refreshNbCoherence(clients,coherence,outil,target){
	consistencyManager.getNbCoherence(coherence).then(function(nbIncoherence){
...
function getNextIncoherence(client,coherence,outil,target,blacklist){
	consistencyManager.getNextIncoherence(coherence,blacklist).then(function(nextIncoherence){
...
function getAllIncoherence(client,coherence,outil,target){
	consistencyManager.getAllIncoherences(coherence).then(function(allIncoherencesWithResponses){
		var allIncoherences=[];
		var responses=[];
...
function validateIncoherence(client,coherence,outil,target,id,responses){
	consistencyManager.validateIncoherence(coherence,id,responses).then(function(allIncoherence){
...
function validateMultipleIncoherence(client,coherence,outil,target,responses){
	consistencyManager.validateMultipleIncoherence(coherence,responses).then(function(){
